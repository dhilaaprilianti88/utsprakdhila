                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="col-md-12">
                                <div class="page-header clearfix">
                                    <h2 class="pull-left">Barang Donasi</h2>
                                    ...
                                    <br>
                                        <?php
                                            ...
                                            $strQuery = "SELECT *, COUNT(id) AS barangbarang FROM penerima GROUP BY(jenis_barang) ORDER BY jenis_barang ASC";
                                            ...
                                            if ($result) {
                                                $arrData = array(
                                                    "chart" => array(
                                                        "caption" => "Jumlah Berdasarkan Barang Yang Dibutuhkan",
                                                        "showValues" => "0",
                                                        "theme" => "fusion"
                                                    )
                                                );
